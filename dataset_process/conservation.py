...
pickle_file_path = f'Dataset/PSSM_{dataset}{end}/pssm_s{dataset}{end}.pkl'  # Replace with the correct path if necessary
output_directory = f'./Dataset/cons_s{dataset}{end}'  # Replace with the correct path if necessary
