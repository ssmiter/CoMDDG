...
def load_dataset(file_path):
    ...
    # 测试检查
    # print("Sample node features shape:", dataset[0]['wild_type']['node_features'].shape)
    # print("Sample edge features shape:", dataset[0]['wild_type']['edge_features'].shape)
...
def prepare_data(file_path):
    ...
    batch_size = BATCH_SIZE # 使用config
